...
export const DashboardMenu = [
	...
	},			
	{
		...
		icon: 'monitor',
		children: [
			{ id: uuid(), link: '/components/studentlist', name: 'StudentList' },
			{ id: uuid(), link: '/components/courselist', name: 'CourseList' },
			{ id: uuid(), link: '/components/topiclist', name: 'TopicList' },
			{ id: uuid(), link: '/components/employeelist', name: 'EmployeeList' },
			{ id: uuid(), link: '/components/teachingassignmentlist', name: 'TeachingAssignmentList' },
			{ id: uuid(), link: '/components/tuitionfeelist', name: 'TuitionFeeList' },
			{ id: uuid(), link: '/components/studentregistration', name: 'StudentRegistration' },
